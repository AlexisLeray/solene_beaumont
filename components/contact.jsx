  ...
  return (
    <div>
      ...
      >
        ...
        <main
          className={{
            /*${style.contact__main_content}*/
          }`container`}
        >
          <div
            className={
              {
                /*style.contact__info_mail*/
              }
            }
          >
            {/*<svg
              ...
              className={
                {
                  style.contact__main__mail_icon
                }
              }
            >
              <path
          ...
          >
            {/*<svg
              ...
              className={
                {
                  /*style.contact__main__location_icon
                }
              }
            >
              <path
          ...
          >
            {/*<svg
              ...
              className={
                {
                  /*style.contact__main__phone_icon
                }
              }
            >
              <path
            ...
            <div
              className={
                {
                  /*style.contact__info__phone_number*/
                }
              }
            >
              <p>02.40.69.16.18</p>
