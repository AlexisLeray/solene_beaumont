    ...
    <div>
      ...
      <main className="container">
        ...
        <p>
          ...
          beaumont-avocat.fr , ci-après le "Site", les présentes mentions
          légales.
        </p>
        <p>
        ...
        <p>
          ...
          BEAUMONT Solène, domiciliée 4 rue racine, dont le numéro de téléphone
          est 0637789029, et l'adresse e-mail "s.beaumont- avocat@outlook.fr".
        </p>
        <h3>ARTICLE 2 - L'HEBERGEUR</h3>
        <p>
          L'hébergeur du Site est la société Netlify, dont le siège social est
          situé au 2325 3RD STREET,SUITE 215, SAN FRANCISCO, CA 94107 (USA),
